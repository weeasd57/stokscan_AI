...
function PopoutChartContent() {
    ...
    if (!symbol) {
        return (
            <div className="w-screen h-screen flex flex-col items-center justify-center bg-zinc-50 text-red-500 dark:bg-[#050816] dark:text-[#ef5350] p-6 text-center">
    ...
    return (
        <div className="w-screen h-screen bg-zinc-50 dark:bg-[#050816] overflow-hidden flex flex-col">

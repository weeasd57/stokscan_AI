                ...
                <div className="w-full">
                    ...
                    <div className="w-full">
                        <div className={isFullscreen 
                            ...
                            : "bg-white dark:bg-black border-4 border-black dark:border-white h-full min-h-[600px] shadow-[8px_8px_0px_rgba(0,0,0,1)] dark:shadow-[8px_8px_0px_rgba(255,255,255,1)] flex flex-col overflow-hidden"}>
                            ...
                            {logsLoading && logs.length === 0 ? (
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-3 flex-1 overflow-hidden min-h-[500px]">
                                    ...
                                    <div className="md:col-span-2 flex flex-col h-full bg-white dark:bg-black overflow-hidden order-last md:order-first">
                                        {selectedGroup ? (
                                            <>

                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
                    ...
                    <div className="space-y-4">
                        ...
                        <ul className="space-y-2">
                            <li><Link href="/scanner/backtests" className="text-sm text-zinc-500 hover:text-indigo-400 transition-colors font-bold text-indigo-400/80">AI Trading Scanner</Link></li>

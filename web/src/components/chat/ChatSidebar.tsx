...
export function ChatSidebar({
    ...
    if (!isOpen) {
        return (
            <button
                onClick={onToggle}
                className="hidden md:block p-2 bg-zinc-100 dark:bg-zinc-800 hover:bg-zinc-200 dark:hover:bg-zinc-700 text-zinc-700 dark:text-zinc-300 rounded-lg transition-colors border border-zinc-300 dark:border-zinc-700 m-2 shadow-sm shrink-0 self-start"
    ...
    return (
        <>
            ...
            <aside className={`
                border-r border-zinc-200 dark:border-zinc-800 flex flex-col h-full text-right select-none transition-all duration-300
                max-md:fixed max-md:top-0 max-md:bottom-0 max-md:right-0 max-md:z-50 max-md:w-[280px] max-md:max-w-[85vw] max-md:shadow-2xl max-md:bg-white dark:max-md:bg-zinc-950

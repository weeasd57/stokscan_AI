...
const translations: Record<string, Record<Language, string>> = {
    ...
    "nav.scanner.ai_trading": { en: "AI Trading Scanner", ar: "بوتات التداول الذكية" },
    ...
    "bots.banner_title": { en: "AI Trading Scanner", ar: "الماسح الذكي للتداول" },
    "bots.banner_desc": { en: "Centralized automated AI bots running under quantitative models. Get instant, high-probability buy signals delivered directly to your Telegram.", ar: "بوتات تداول مؤتمتة مركزية تعمل بنماذج كمية. احصل على إشارات شراء فورية عالية الاحتمالية مباشرة على حساب تليجرام الخاص بك." },
    ...
    "backtest.net_profit": { en: "Net Profit", ar: "صافي الأرباح" },
    "backtest.total_trades": { en: "Total Trades", ar: "إجمالي الصفقات" },
    "backtest.avg_return": { en: "Avg Return", ar: "متوسط العائد" },
    ...
    "backtest.stats.avg_profit": { en: "Avg Profit / Run", ar: "متوسط الربح / اختبار" },

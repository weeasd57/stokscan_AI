...
const translations: Record<string, Record<Language, string>> = {
    ...
    "profile.notification.channel.whatsapp": { en: "WhatsApp Service", ar: "خدمة واتساب" },
    ...
    "profile.notification.whatsapp.desc": { en: "Enter your phone number below to receive signals directly via WhatsApp.", ar: "أدخل رقم هاتفك أدناه لاستلام الإشارات الفورية مباشرة عبر تطبيق الواتساب." },
    "profile.notification.whatsapp.placeholder": { en: "e.g. 201012345678", ar: "مثال: 201012345678" },
    "profile.notification.whatsapp.label": { en: "WhatsApp Number (with country code)", ar: "رقم الواتساب (مع رمز الدولة)" },
    "profile.notification.whatsapp.invalid": { en: "Please enter a valid WhatsApp number (only digits, length 10-15)", ar: "يرجى إدخال رقم واتساب صحيح (أرقام فقط، طول 10-15)" },
    "profile.notification.telegram.status": { en: "Telegram Status", ar: "حالة تليجرام" },
    "profile.notification.whatsapp.status": { en: "WhatsApp Status", ar: "حالة واتساب" },
    "profile.notification.whatsapp.linked": { en: "Number Saved", ar: "تم حفظ الرقم" },
